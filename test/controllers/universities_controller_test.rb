...
class UniversitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university" do
    assert_difference("University.count") do
      post universities_url, params: { university: { country: @university.country, name: @university.name } }
    end
  ...
  test "should update university" do
    patch university_url(@university), params: { university: { country: @university.country, name: @university.name } }
